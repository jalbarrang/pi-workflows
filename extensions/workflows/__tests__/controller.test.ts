...
import { MAX_AGENT_CALLS, RunController } from "../run/controller.ts";
...
test("RunController preserves task failures during run teardown", async () => {
  ...
  rejectTask?.(new Error("provider failure"));
